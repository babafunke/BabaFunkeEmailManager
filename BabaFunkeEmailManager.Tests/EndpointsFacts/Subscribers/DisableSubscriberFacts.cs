...
namespace BabaFunkeEmailManager.Tests.EndpointsFacts.Subscribers
{
    public class DisableSubscriberFacts
    {
        ...
        [Fact]
        public async Task DisableSubscriber_ShouldCallServiceOnce()
        {
        ...
        [Fact]
        public async Task DisableSubscriber_ShouldReturnOkObjectResult_IfSuccessful()
        {
            _service.Setup(s => s.DisableItem(It.IsAny<string>()))
        ...
        [Fact]
        public async Task DisableSubscriber_ShouldReturnBadRequestObjectResult_IfFailed()
        {
            _service.Setup(s => s.DisableItem(It.IsAny<string>()))
